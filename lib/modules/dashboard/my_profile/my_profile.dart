                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      SizedBox(height: 10,),
                        Text("Employee Certificates",style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                        )),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text("Date Achieved", style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                              ),),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                width:100,
                                child: Text("AI operations(AIOps)Fundamentals" ,style: TextStyle(
                                  fontSize: 16,
                                  // overflow: TextOverflow.ellipsis

                                ),),
                              ),
                              Text("07/04/2023", style: TextStyle(
                                fontSize: 16,
                              ),),
                              Row(
                                children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                width:100,
                                child: Text("Agilityhealth-Certified AgilityHealth Facilitator" ,style: TextStyle(
                                  fontSize: 16,
                                  // overflow: TextOverflow.ellipsis

                                ),),
                              ),
                              Text("04/03/2023", style: TextStyle(
                                fontSize: 16,
                              ),),
                              Row(
                                children: [
